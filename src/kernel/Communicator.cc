...
struct CommConnEntry {
  ...
  long long seq;                //*序列号
  int sockfd;                   //*对应的通信文件描述符
#define CONN_STATE_CONNECTING 0 //*连接成功
#define CONN_STATE_CONNECTED 1  //*连接中
#define CONN_STATE_RECEIVING 2  //*接受数据中
#define CONN_STATE_SUCCESS 3    //*成功
#define CONN_STATE_IDLE 4       //*空闲
#define CONN_STATE_KEEPALIVE 5  //*keeplive
#define CONN_STATE_CLOSING 6    //*关闭中
